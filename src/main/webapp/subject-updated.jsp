...
<body>
	...
	<caption>
		<h3>
		<c:if test="${subject != null}">Edit Previous subject Details</c:if>
		<c:if test="${subject == null}"><h3>Edit Form Below</h3><br></c:if></h3>
	</caption>
	...
	<button type="button" class="button"><a href="DeleteServlet?id=<c:out value='${subject.id}' />">Delete</a></button><br><br>
	</form>
